...
**3 principales rutas de conversión de la pregnenolona** en la corteza suprarrenal:

### 1. **Síntesis de Cortisol (glucocorticoide)**

**Zona**: _Zona fasciculada_

**Ruta**:  
Colesterol → Pregnenolona → 17α-hidroxipregnenolona → 17α-hidroxiprogesterona → 11-desoxicortisol → **Cortisol**

**Enzimas clave**:

- **CYP11A1** (P450scc): convierte colesterol en pregnenolona. **Vitamina D (1α,25-dihidroxivitamina D3)**: _aumenta_ la expresión de CYP11A1 [(Lundqvist et al., 2010)](https://consensus.app/papers/1alpha25dihydroxyvitamin-d3-affects-hormone-production-lundqvist-norlin/f44d0e258c505fd1a44fb341d62613fd/?utm_source=chatgpt).
    
- **CYP17A1** (17α-hidroxilasa): añade el grupo OH en C17
    
- **HSD3B2**: convierte pregnenolona en progesterona
    
- **CYP21A2** (21-hidroxilasa): añade OH en C21
    
- **CYP11B1** (11β-hidroxilasa): último paso para formar cortisol
    

---

### 2. **Síntesis de Andrógenos (DHEA y derivados)**

**Zona**: _Zona reticular_

**Ruta**:  
Colesterol → Pregnenolona → 17α-hidroxipregnenolona → **DHEA** → Androstenediona → Testosterona (en tejidos periféricos)

**Enzimas clave**:

- **CYP11A1**
    
- **CYP17A1** (tiene dos funciones):
    
    - 17α-hidroxilasa
        
    - **17,20-liasa** → esta función es crucial para generar DHEA
        
- **SULT2A1**: puede sulfatar DHEA para almacenamiento
    
- _(En tejidos periféricos: 17β-HSD y 5α-reductasa para convertir a testosterona o DHT)_
    

---

### 3. **Síntesis de Aldosterona (mineralocorticoide)**

**Zona**: _Zona glomerulosa_

**Ruta**:  
Colesterol → Pregnenolona → Progesterona → 11-desoxicorticosterona → Corticosterona → **Aldosterona**
...
- **CYP11B2** (aldosterona sintasa) → exclusiva de la zona glomerulosa. Último paso en la conversión a aldosterona. **Elevación de potasio en sangre** la estimula.
