...
- **Antioxidante liposoluble** en membranas del folículo piloso → protege del estrés oxidativo que miniaturiza el folículo en la alopecia androgenética.
- **Mejora la microcirculación** del cuero cabelludo (efecto vasodilatador leve, similar pero más suave que el [[Minoxidil]]).
- **Apoya la steroidogénesis** (producción de hormonas esteroideas) y la señalización androgénica tisular.
- **Antiinflamatorio tópico** — el cuero cabelludo con AGA tiene inflamación subclónica perfolicular.
...
| Intervención | Mecanismo | Eficacia AGA | Efectos adversos |
|---|---|---|---|
| **Vitamina E oral/tópica** | Antioxidante, antiinflamatorio, microcirculación | Modesta (++) | Escasos |
| **[[Finasteride]] oral** | Inhibe 5α-reductasa tipo II → ↓DHT ~70% | Alta (++++) | ↓libido, DE, ↓[[Alopregnanolona|ALLO]], posible "síndrome post-finasteride" |
| **[[Minoxidil]] tópico** | Vasodilatador, prolonga fase anágena | Alta (+++) | Irritación, ↑[[Prolactina|prolactina]], hipertricosis facial |
| **Aceite de oliva tópico** | Vehículo + Vit E + ácido oleico + polifenoles | Baja-moderada (+) | Escasos (acné, grasitud) |

> "Finasteride is like male birth control, lot of mf's need that to be kept in check"
> _—@randomcanddy (2 jun 2026)_

> "hikaye hiç bir şey finasterid in yaptığını yapamıyor"
> _—@EnginOzbalik (2 jun 2026) [traducción libre: "ningún cuento puede hacer lo que hace el finasteride"]_
